...
const PrivacyPolicy1 = () => {
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto text-gray-800 bg-white shadow-lg rounded-2xl mt-40 pt-[70px]">
     
      <h3 className="text-sm text-gray-500 mb-8 text-center">Last updated on Apr 22 2025</h3>

      <section className="mb-6">
        <p>
          This privacy policy sets out how <strong>Corcus Studio LLP</strong> uses and protects any information that you give
          Corcus Studio LLP when you visit their website and/or agree to purchase from them.
        </p>
        <p className="mt-4">
          Corcus Studio LLP is committed to ensuring that your privacy is protected. Should we ask you to provide certain
        ...
        <p className="mt-4">
          Corcus Studio LLP may change this policy from time to time by updating this page. You should check this page from
          time to time to ensure that you adhere to these changes.
        </p>
      </section>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">Information We May Collect</h2>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">What We Do With the Information</h2>
        <ul className="list-disc pl-6 space-y-2">
        ...
        <p className="mt-4">
          ...
          we have put in suitable measures.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Whenever you are asked to fill in a form on the website, look for the box that you can click to indicate that you
          ...
          <li>
            ...
            your mind at any time by writing to or emailing us at <a href="mailto:contact@corcus.in" className="text-blue-600 underline">contact@corcus.in</a>
          </li>
          <li>
          ...
          <li>
            We may use your personal information to send you promotional information about third parties which we think you
        ...
        <p className="mt-4">
          ...
          Chandraprabha Kunj, Lavkush Nagar, Sonu Market, Gola Road, Patna, Bihar 801503 or contact us at 8789677330 or
          <a href="mailto:contact@corcus.in" className="text-blue-600 underline"> contact@corcus.in</a> as soon as possible. We will promptly correct any information
