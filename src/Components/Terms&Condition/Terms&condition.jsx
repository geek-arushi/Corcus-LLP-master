    ...
    <div className="container mx-auto px-4 mt-20 pb-10">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          "our" refer to
          <strong> Corcus Studio LLP</strong>, whose registered/operational
          office is Chandraprabha Kunj, Lavkush Nagar, Sonu Market, Gola Road,
          Patna, Bihar 801503. "you", "your", "user", "visitor" shall mean any
          natural or legal person who is visiting our website and/or has agreed
          to purchase from us.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-3">
          ...
          <li>
            ...
            document without Corcus Studio LLP’s prior written consent.
          </li>
          <li>
