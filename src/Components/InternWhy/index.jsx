          ...
          <div className="row g-4">
            ...
            <div className="col-md-4">
              <div className="card bg-black text-white h-100 border-0">
                <div className="card-body d-flex flex-column p-4">
                  {/* Heading */}
                  <h3 className="text-white mb-4">Real-world Experience</h3>
            ...
            <div className="col-md-4">
              <div className="card bg-black text-white h-100 border-0">
                <div className="card-body d-flex flex-column p-4">
                  {/* Heading */}
                  <h3 className="text-white mb-4">Professional Networking</h3>
                  <p className="card-text text-white text-start">
            ...
            <div className="col-md-4">
              <div className="card bg-black text-white h-100 border-0">
                <div className="card-body d-flex flex-column p-4">
                  {/* Heading */}
                  <h3 className="text-white mb-4">Career Support</h3>
                  <p className="card-text text-white text-start">
