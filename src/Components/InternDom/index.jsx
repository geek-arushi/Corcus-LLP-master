  ...
  const domains = [
    {
      ...
      image: '/images/beginner-web.jpg', // Add your image path here
      bgColor: '#f5f5f5',
      tagBg: '#FFBF00',
      textColor: '#000',
    ...
    },
    {
      title: 'INTERMEDIATE',
      subtitle: 'WEB DEVELOPER',
      image: '/images/intermediate-web.jpg', // Add your image path here
      bgColor: '#ffc107',
      tagBg: '#000',
      textColor: '#000',
      tagTextColor: '#fff',
    ...
    },
    {
      title: 'SHOPIFY',
      subtitle: 'ECOMERCE',
      image: '/images/shopify-ecommerce.jpg', // Add your image path here
      bgColor: '#f5f5f5',
      tagBg: '#FFBF00',
      textColor: '#000',
