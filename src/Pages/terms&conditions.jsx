...
const TermsAndConditions = () => {
  return (
    <div className="p-6 md:p-10 max-w-4xl mx-auto text-gray-800 bg-white shadow-lg rounded-2xl mt-40 pt-[70px]">
      <h1 className="text-4xl font-bold mb-6 text-center border-b pb-4">Terms and Conditions</h1>
      <p className="text-sm text-gray-500 mb-8 text-center">Last updated on Apr 22 2025</p>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">Introduction</h2>
        <p>
          For the purpose of these Terms and Conditions, the terms "we", "us", "our" refer to
          <strong> Corcus Studio LLP</strong>, whose registered/operational office is Chandraprabha Kunj, Lavkush Nagar, Sonu
          Market, Gola Road, Patna, Bihar 801503. "you", "your", "user", "visitor" shall mean any natural or legal person who
          is visiting our website and/or has agreed to purchase from us.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-3">
          ...
          <li>
            Your use of any information or materials on our website and/or product pages is entirely at your own risk, for
            which we shall not be liable. It shall be your own responsibility to ensure that any products, services or
            information available through our website and/or product pages meet your specific requirements.
          </li>
          <li>
          ...
          <li>
            You may not create a link to our website from another website or document without Corcus Studio LLP’s prior
            written consent.
          </li>
          <li>
          ...
          <li>
            We shall be under no liability whatsoever in respect of any loss or damage arising directly or indirectly out of
            the decline of authorization for any Transaction, on Account of the Cardholder having exceeded the preset limit
